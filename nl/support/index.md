...
sections:
  ...
  - id: apple-watch-sync
    title: Apple Watch-synchronisatie
  - id: widgets
    title: Widgets
  - id: family-sharing
    title: Gezinsdeling
...
Als je aftellingen niet op je apparaten worden gesynchroniseerd, volg je deze stappen op elk apparaat.

### 1. Controleer je iCloud-instellingen
...
- Open het Apple-menu () en kies **Systeeminstellingen**.
- Klik bovenaan op je naam.
- Zorg dat de weergegeven Apple Account dezelfde is als die je op je andere apparaten gebruikt.
- Klik op **iCloud**.
...
Voor synchronisatie is voldoende vrije iCloud-opslag nodig. Controleer of je account niet zonder opslagruimte zit.
...
Als je aftellingen niet met Apple Watch worden gesynchroniseerd, probeer je deze stappen.

### 1. Start je apparaten opnieuw op

Start zowel je iPhone als Apple Watch opnieuw op. Dit lost tijdelijke synchronisatieproblemen meestal op.
...
- [Widgets toevoegen en bewerken op je iPhone]({% include apple-support-url.html key="iphone_widgets" %})
...
### 1. Start je apparaat opnieuw op

Door je apparaat opnieuw op te starten, worden tijdelijke widgetproblemen meestal opgelost.
...
Als er iets mis is, geef ons dan de kans om het recht te zetten. Alleen Apple kan terugbetalingen voor aankopen in de App Store uitvoeren. Volg [het terugbetalingsproces van Apple]({% include apple-support-url.html key="refunds" %}) om er een aan te vragen.
